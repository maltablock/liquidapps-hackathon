...
const N_hex = Buffer.from(byteArr).toString(`hex`)
const N_fromHex = new BigInteger(Buffer.from(N_hex, `hex`))
console.log(N_hex)
console.log(N_fromHex.toString(16))
console.log(initial.equals(N_fromHex))
console.log(Bob.key.exportKey(``))
